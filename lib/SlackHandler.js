        ...
        switch (event.type) {
            ...
            case "group_change_success":
                attachment = {
                    ...
                    "text": "The group `" + event.data.groupId + "` completed at " + clearDateString(event.data.timestamp) + ". See " + event.data.groupId,
                    "color": "#7CD197",
                    "mrkdwn_in": ["text"],
                    "ts": (new Date().getTime()/1000)
                };
            ...
            case "group_change_failed":
                attachment = {
                    ...
                    "text": "The group `" + event.data.groupId + "` failed at " + clearDateString(event.data.timestamp) + ". See " + event.data.groupId,
                    "color": "#ff0000",
                    "mrkdwn_in": ["text"],
                    "ts": (new Date().getTime()/1000)
                };
